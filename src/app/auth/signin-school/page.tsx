...
function SignInForm() {
  ...
  return (
    <div
      ...
      style={{
        background: "radial-gradient(ellipse 80% 60% at 50% -10%, rgba(234,108,10,0.08) 0%, transparent 60%), var(--surface-base)",
      }}
    >
      <div className="w-full max-w-[420px]">
        ...
        <div className="card p-8">
          {/* Header */}
          <div className="mb-7">
            <div className="w-11 h-11 bg-accent-50 rounded-2xl flex items-center justify-center mb-5 text-xl">
              🏫
            </div>
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              Manage job postings and review teacher applications
            </p>
          </div>
          ...
          <form onSubmit={handleCredentials} className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-[15px] font-semibold text-white transition-all duration-[120ms] shadow-md disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-px active:translate-y-0 mt-1"
              style={{ background: "linear-gradient(135deg, #ea6c0a 0%, #c2570a 100%)" }}
            >
              {loading ? (
                <>
          ...
          <div className="mt-7 pt-5 border-t border-black/[0.05] space-y-3 text-center">
            <p className="text-sm text-gray-600">
              New school?{" "}
              <Link href="/auth/signup?role=school" className="text-brand-600 font-semibold hover:text-brand-700 transition-colors">
                Create account
              </Link>
            </p>
