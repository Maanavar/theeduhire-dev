...
function SignInForm() {
  ...
  const handleCredentials = async (e: React.FormEvent) => {
    ...
    if (result?.ok) {
      ...
      // Validate that this is a teacher account
      if (role !== "TEACHER") {
      ...
      setSuccess("Welcome back! Signed in as Teacher.");
      setLoading(false);
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl shadow-blue-500/10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Sign in to access your teaching applications and saved jobs
            </p>
          </div>
          ...
          <form onSubmit={handleCredentials} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-50/50 border border-gray-200/60 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 text-sm"
                />
            ...
            <button
              ...
              className="w-full py-3.5 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold rounded-2xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:from-blue-500 disabled:hover:to-indigo-600 flex items-center justify-center gap-2 shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30"
            >
              {loading && (
